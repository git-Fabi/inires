...
def test_setup_reader_agent(mock_IssueReaderAgent):
    # Arrange
    mock_instance = MagicMock()
    mock_IssueReaderAgent.return_value = mock_instance
    ...
    # Assert
    mock_IssueReaderAgent.assert_called_once_with(name="ticket_reader_agent")
